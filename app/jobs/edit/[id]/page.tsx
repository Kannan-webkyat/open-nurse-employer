...
export default function EditJobPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    applicationProcess: "",
    category: "",
    isSponsorshipAvailable: false as boolean,
  })
    ...
    const fetchJob = async () => {
      ...
      try {
        ...
        if (response.success && 'data' in response && response.data) {
          ...
          setFormData({
            jobRole: job.job_role || job.title || "",
            jobId: job.job_id || "",
            ...
            isSponsorshipAvailable: !!job.is_sponsorship_available,
          })
        } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: any = {
        ...
        is_sponsorship_available: formData.isSponsorshipAvailable,
      }
            ...
            <div className="bg-white rounded-lg border border-neutral-200 p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <select
                    value={formData.isSponsorshipAvailable ? "Yes" : "No"}
                    onChange={(e) => handleInputChange("isSponsorshipAvailable", e.target.value === "Yes")}
                    className="flex h-10 w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-0 focus-visible:border-[#0576B8]"
                  >
