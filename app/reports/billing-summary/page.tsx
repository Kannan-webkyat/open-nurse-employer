      ...
      <div className="space-y-6 max-w-[1600px] mx-auto">
        ...
        <div className="relative z-20 flex flex-col xl:flex-row xl:items-center justify-between">
          ...
          <div className="relative z-10">
            ...
            <p className="text-neutral-600 mt-1">Comprehensive billing overview & history</p>
          </div>
              ...
              <div className="relative z-10 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 w-full">
                ...
                <div className="relative group w-full sm:flex-1 sm:min-w-[200px] xl:max-w-xs">
                  ...
                  <input
                    ...
                    className="pl-9 pr-4 py-1.5 border border-neutral-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 w-full transition-all shadow-sm"
                  />
                </div>
